...
<div class="container-fluid p-3">
	<div class="row">
		<div class="col-md-3 text-success">
			<h3>
				<i class="fa-solid fa-book-open-reader"></i> Aurora
			</h3>
		</div>
		...
		<div class="col-md-3">
			<a href="login.jsp" class="btn btn-sucess"><i class="fa-solid fa-right-to-bracket"></i> Login</a> 
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active"><a class="nav-link" href="#"><i
					class="fas fa-house"></i> Home<span class="sr-only">(current)</span></a>
			</li>
			<li class="nav-item active"><a class="nav-link" href="#"><i
					class="fa-solid fa-book-open-reader"></i> Introduction</a></li>
			<li class="nav-item active"><a class="nav-link" href="#"><i
					class="fa-solid fa-book"></i> Blog</a></li>
			<li class="nav-item active"><a class="nav-link" href="#"><i
